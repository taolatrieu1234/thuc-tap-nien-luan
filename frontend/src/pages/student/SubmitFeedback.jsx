  ...
  return (
    <div className="submit-feedback-container">
      ...
      <div className="submit-content">
        <div className={`user-info-banner ${isAnonymous ? 'anonymous-mode' : 'public-mode'}`}>
          {isAnonymous ? (
            <p className="flex-center">
              <ShieldAlert size={20} style={{ marginRight: '8px' }} />
              <strong>Chế độ Ẩn danh:</strong> Danh tính của bạn sẽ được bảo mật tuyệt đối với Cán bộ xử lý.
            </p>
          ) : (
            <p className="flex-center">
              <Eye size={20} style={{ marginRight: '8px' }} />
              <strong>Chế độ Công khai:</strong> Phản ánh gửi dưới tên {user?.full_name} ({user?.student_code})
            </p>
          )}
        </div>
        ...
        <form onSubmit={handleSubmit} className="feedback-form">
          ...
          <div className="form-group checkbox-group">
            <label className="checkbox-container">
              ...
              Gửi phản ánh Ẩn danh (Nhà trường cam kết bảo mật danh tính của bạn)
            </label>
          </div>
